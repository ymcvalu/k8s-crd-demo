...
import (
	...
	"nfs-controller/pkg/client/clientset/versioned/scheme"
...
func (c *SamplecrdV1Client) NFSVolumes(namespace string) NFSVolumeInterface {
	return newNFSVolumes(c, namespace)
}
